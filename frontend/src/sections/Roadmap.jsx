...
const Roadmap = () => {
  return (
    <div
      id="roadmap"
      className="mt-[200px] w-full h-fit px-[30px] xmd:px-[60px] xl:px-[120px]"
    >
      <div className="relative w-full flex flex-col gap-[20px] xm:gap-0 xl:flex-row xl:justify-between xl:items-end">
        <img
          className="w-[75.38px] absolute left-[-30px] top-0 rotate-[-30deg]"
          src={ourIcon}
          alt="our icon"
        />
        <h1 className="font-Gulfs text-[60px] xmd:text-[84px] leading-[75.6px] uppercase">
          Roadmap
        </h1>
